...
export default function PostsPage() {
  const [rows, setRows] = useState<PostWithDetails[]>([]);
  ...
  useEffect(() => {
    ...
    load();
    return () => { active = false; };
  }, [search, status, platform, sort, dateRange, getCreatedAfter]);
      ...
      <div className="card">
        ...
        {loading ? (
          <div style={{ padding: "1.25rem" }}>
            <div className="skeleton skeleton-row" style={{ height: "80px", marginBottom: "0.75rem" }} />
            <div className="skeleton skeleton-row" style={{ height: "80px", marginBottom: "0.75rem" }} />
            <div className="skeleton skeleton-row" style={{ height: "80px", marginBottom: "0.75rem" }} />
          </div>
        ) : rows.length === 0 ? (
